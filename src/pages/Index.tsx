  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-full group cursor-pointer">
        ...
        >
          <img
            src="https://cdn.builder.io/api/v1/image/assets%2F175e07c0953248be8def67c5d8e27247%2F9dac1cf560d446aa83ae5d63cd9af7e2?format=webp&width=2560&quality=95"
            alt="Altibbe Health Innovation Technology"
            ...
            onMouseEnter={(e) => {
              e.target.style.transform =
                "translate3d(0, 0, 0) scale3d(1.03, 1.03, 1)";
            }}
            onMouseLeave={(e) => {
              e.target.style.transform =
